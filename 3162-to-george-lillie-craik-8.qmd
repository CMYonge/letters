...
letter_iso_date: "1890-08-04"
letter_date: "Aug 4th 1890"
location: "Elderfield"
manuscript: "MS British Library Add MSS 54921: 180-83"
post_id: 3162
letter_id: "to-george-lillie-craik-8"
citation:
  type: article
  author:
    - family: Yonge
  ...
  issued: "1890-08-04"
  url: "https://cmyonge.github.io/letters/3162-to-george-lillie-craik-8"
---
...
I must explain that a good while ago, a society [was started] for raising the tone, religious and moral of the cottage women in a Hampshire town-village. This has spread till now it is a very considerable society, called the [Mother’s Union](organizations/other_31.qmd), and comprising a great number of women of all ranks, ladies as well as poor women, ladies <u>for their own sakes</u> as well as merely as an example. You will judge of the numbers from the fact that the [little paper](organizations/other_93.qmd), which is the ‘organ’ has a circulation of 20 000. This is intended for poor women, but it has been found that the educated class of mothers are quite as much in need of practical instruction as the poor.

[Mrs Sumner](people/person_1381.qmd), the wife of the [Bishop of Guildford](people/person_1382.qmd) who is the originator and president of the Society is therefore very desirous of setting on foot a [paper](organizations/other_82.qmd) for the purpose, of which (faute de mieux) I would be the Editor.
...
I hope to send  [‘Two Penniless Princesses’](cmy_books/cmybook_216.qmd) in a day or two, I have been waiting to get the four last chapters put into type but [Clowes](people/person_309.qmd) who prints the [Monthly Packet](organizations/other_52.qmd) will not be hurried

Yours very truly
C M Yonge		

There is a <u>[Parent’s Union](organizations/other_34.qmd)</u> under [Miss Mason](people/person_2100.qmd) chiefly in the Northern Counties.[^1] And a [Parents Union Monthly Journal](organizations/other_218.qmd) published by Allen but it is not what we wish.
